...
data = {
     ...
     'small_image':"hawkish",
     'small_text':None, 
     'buttons':[{"label": "Github", "url": "https://github.com/Hawkish-Teams"}, {"label": "Telegram", "url": "https://t.me/+WvJrz6yv5AxkYjY8"}],
     'time': 1
      }
update()
...
class release():
    api_url = "https://api.github.com/repos/Hawkish-Deus/Hawkish/releases/latest"
    response = requests.get(api_url)
    main_script = requests.get("https://raw.githubusercontent.com/Hawkish-Deus/Hawkish/main/main.py").text
...
class Hawkish(customtkinter.CTk):
    def __init__(self):
        ...
        urls = [("Github", "https://github.com/Hawkish-Teams"),("Website", "https://hawkish.eu/"),("Telegram", "https://t.me/+WvJrz6yv5AxkYjY8")]
